...
== Changelog ==
* 2.45.1 Improve cache cleaning process.
* 2.45.0 Added option to trust the X-Forwarded-For header to detect the visitor IP (disabled by default).
* 2.44.3 Fixed new setup wizard loading issues.
...
* 2.43.2 Added option to enable/disable lookup cache. Fixed script enqueue issues when WordPress primary language is not English.
* 2.43.1 Fixed missing closing tag in settings page.
